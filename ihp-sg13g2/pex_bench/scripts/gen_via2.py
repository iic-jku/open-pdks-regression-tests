...
M = {"m1":(8,0,8,2),"m2":(10,0,10,2),"m3":(30,0,30,2),"m5":(67,0,67,2),
     "tm1":(126,0,126,2),"tm2":(134,0,134,2)}
# via layer, size, min spacing per the SG13G2 rules
V = {("m1","m2"):(19,0,0.19,0.22),("m2","m3"):(29,0,0.19,0.22),
     ("m5","tm1"):(125,0,0.42,0.42),("tm1","tm2"):(133,0,0.90,1.06)}
