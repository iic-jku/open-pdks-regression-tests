...
N 720 -370 820 -370 {lab=VDD}
N 720 -220 720 -200 {lab=S}
N 420 -240 420 -200 {lab=VSS}
N 480 -220 480 -160 {lab=S}
N 420 -380 480 -380 {lab=S}
N 480 -160 820 -160 {lab=S}
N 820 -270 820 -160 {lab=S}
N 720 -270 820 -270 {lab=S}
N 480 -220 720 -220 {lab=S}
N 480 -380 480 -220 {lab=S}
...
C {lab_pin.sym} 820 -370 2 0 {name=p6 sig_type=std_logic lab=VDD}
