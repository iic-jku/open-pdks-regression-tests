...
# everywhere: Metal5 in libs.tech/klayout/tech/gf180mcu.map, allm5/metal5 in the Magic deck.
# There is no separate TopMetal layer here and no skipped count, so m5 is unambiguous.
# The pin datatype is 10 in this PDK, not 2 as in the IHP ones.
